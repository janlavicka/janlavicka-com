...
export function meta() {
  const webPage: WithContext<WebPage> = {
    ...
    "@type": "WebPage",
    name: "Uses",
    description: "Tools and apps Jan Lavička uses for software development.",
    url: `${import.meta.env.VITE_APP_URL}/uses`,
  };
...
export default function Page() {
  return (
    <PageContext.Provider value={{ fileName: "src/routes/uses.tsx", isError: false }}>
      <Layout>
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="mb-8">
            <Text>
              <p>
                If is someone intrested in my setup, and what tools I use, here is a list organized by type of tool/app
                in my toolbelt.
              </p>
            </Text>
          </div>
          ...
          <List>
            ...
            <Item>
              <p className="leading-normal">
                <a href="https://cyberduck.io" className="font-bold underline text-neutral-900 hover:text-blue-500">
                  Cyberduck
                </a>
              </p>
            </Item>
